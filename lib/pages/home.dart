...
class MyHomePage extends StatefulWidget {
  ...
  final Appointment closestAppointment = Appointment( date: new DateTime.utc(2021, 7, 23), time: new TimeOfDay(hour: 15, minute: 0), description: "Primera Dosis".toUpperCase());
